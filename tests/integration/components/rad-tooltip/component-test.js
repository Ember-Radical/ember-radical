...
moduleForComponent('rad-tooltip', 'Integration | Component | rad tooltip', {
  integration: true
});

test('it renders', function(assert) {
  this.render(hbs`{{rad-tooltip Title="Hover me" Content="For some rad info"}}`);
...
test('property buttonStyle binds the appropriate classes', function(assert) {
  ...
  this.render(hbs`{{rad-tooltip Title="Hover me" Content="For some rad info" buttonStyle=true}}`);
