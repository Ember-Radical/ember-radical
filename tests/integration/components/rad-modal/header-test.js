...
module('Integration | Component | rad modal/header', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    assert.ok(find('*').textContent.includes('Test Header'),
  ...
  test('it binds appropriate attrs', async function(assert) {
    ...
    assert.notOk(find('header').classList.contains('primary-bg'),
      'without a brand no brand classes should be rendered');
    assert.notOk(find('header').classList.contains('branded'),
      'without a brand no brand classes should be rendered');
    assert.equal(find('[data-test="rad-modal-close-button"]').getAttribute('aria-label'), 'close',
  ...
  test('it binds appropriate brand classes', async function(assert) {
    ...
    assert.ok(find('header').classList.contains('primary-bg'),
      'passed brand should render brand class');
    assert.ok(find('header').classList.contains('branded'),
  ...
  test('it binds close button svgId to passed closeIcon', async function(assert) {
    ...
    assert.ok(find('svg').classList.contains('arrow-down'),
  ...
  test('it hides the close button if configured', async function(assert) {
    ...
    assert.notOk(findAll('[data-test="rad-modal-close-button"]').length,
