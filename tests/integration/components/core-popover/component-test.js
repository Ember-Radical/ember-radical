...
moduleForComponent('core-popover', 'Integration | Component | core popover', {
  integration: true
});
...
test('it renders', function(assert) {
  this.render(hbs`
    {{#core-popover data-test="render-test" as |components|}}
...
test('Accessibility attrs are set up correctly', function(assert) {
  this.render(hbs`
    {{#core-popover data-test="accessibility-test" as |components|}}
...
test('Content is passed through correctly', function(assert) {
  this.render(hbs`
    {{#core-popover data-test="content-test" as |components|}}
...
test('Popover becomes visible on hover', function(assert) {
  this.render(hbs`
    {{#core-popover data-test="interact-test" as |components|}}
...
test('Popover customization attrs are correctly passed through', function(assert) {
  this.render(hbs`
    {{#core-popover size="large" position="top" data-test="customize-test" as |components|}}
