...
moduleForComponent('core-modal/header', 'Integration | Component | core modal/modal header', {
  integration: true
});
...
test('it renders', function(assert) {
  ...
  this.render(hbs`
    {{#core-modal/header closeModal=(action 'toggleModal') aria-labelledby='aria'}}
      Test Header
    {{/core-modal/header}}
  `);
...
test('it binds appropriate brand classes', function(assert) {
  ...
  this.render(hbs`
    {{#core-modal/header brand='primary' closeModal=(action 'toggleModal') aria-labelledby='aria'}}
      Test Header
    {{/core-modal/header}}
  `);
...
test('it hides the close x if configured', function(assert) {
  ...
  this.render(hbs`
    {{#core-modal/header closeModal=(action 'toggleModal') aria-labelledby='aria' hideX=true}}
      Test Header
    {{/core-modal/header}}
  `);
