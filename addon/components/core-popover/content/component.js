 ...
 *
 * @class Component.CorePopover.Content
 * @constructor
...
export default Component.extend({
  ...
  size: '',
  /**
   * Unique string generated by parent `core-popover` Used for 508 attrs. Is
   ...
   * `core-popover` element. Real abnoxious when you're trying to click something.
