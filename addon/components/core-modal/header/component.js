 ...
 * be accessed via the `Header` prop or `components` hash of `core-modal`.
 *
 * ### Accessibility
 *
 ...
 *
 * @class Component.CoreModal.Header
 * @constructor
...
export default Component.extend({
  ...
  init() {
    ...
    // This id matches the `aria-labelledby` of the core-modal instance.
  ...
  layout: hbs`
    ...
    {{#unless hideX}}
      {{#core-button
        ...
        {{core-svg svgId="x" classNames=(concat 'modal-svg ' (if brand brand))}}
      {{/core-button}}
    {{/unless}}
  `
});
